...
using System;
    ...
    class MenuState : GameRunning
    {
        ...
        public override void SpawnLevel()
        {
            ...
            GameObject lev = GameObject.Instantiate(ParentMachine.Component.levels[levno], levelGenPos, Quaternion.identity) as GameObject;
            lev.GetComponent<Rigidbody2D>().velocity = new Vector2(0, gamespeed);
        }
    }
    ...
    class GamePlay:GameRunning
    {
        ...
        bool Paused;
        public float SpawnMin = 2.0f, SpawnMax = 4.0f, spTime,PauseTimeScale;
        ...
        public override IEnumerator run()
        {
            ...
            while (ParentMachine.Current.GetType() == GetType())
            {
                ...
                if (ElapsedTime >= 3.0f && Time.timeScale <= 4.0f)
                {
                    Time.timeScale += 0.1f;
                    ElapsedTime = 0;
                }
